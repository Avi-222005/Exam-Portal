...
const candidateTargetExam = ref<ExamWithProblems | null>(null);
...
<template>
  <div class="w-full max-w-[1440px]">
          ...
          <table class="w-full text-[13px]">
            ...
            <tbody class="[&>tr:last-child>td]:border-b-0">
              ...
              >
                ...
                >
                  <span
                    class="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[11px] font-bold uppercase tracking-wider"
                    :class="{
                      'bg-purple-500/10 text-purple-600 dark:text-purple-400':
                        exam.accessType === 'passcode',
                      'bg-amber-500/10 text-amber-600 dark:text-amber-400':
                        exam.accessType === 'whitelist',
                      'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400':
                        !exam.accessType || exam.accessType === 'open',
                    }"
                  >
                    <span v-if="exam.accessType === 'passcode'">🔑 Passcode</span>
                    <span v-else-if="exam.accessType === 'whitelist'">🛡️ Whitelist</span>
                ...
                >
                  <div class="flex gap-1.5 items-center">
                    ...
                    <RegalButton
                      @click="candidateTargetExam = exam"
                    >
                      Candidates
                    </RegalButton>
    ...
    <ExamCandidateModal
      v-if="candidateTargetExam"
      :exam-id="candidateTargetExam.id"
      :exam-title="candidateTargetExam.title"
      :access-type="candidateTargetExam.accessType"
      @close="candidateTargetExam = null"
      @updated="load"
    />
  </div>
</template>
