...
export async function startTour() {
  ...
  const driverObj = driver({
    ...
    steps: [
      {
        element: '[data-tour="problems-sidebar"]',
        popover: {
          title: 'Problem List',
          description:
            'Browse and select from all assigned coding problems and MCQ sections. Each problem shows its difficulty level and solve status.',
          side: 'right',
          align: 'start',
        },
      },
