...
export const LEGACY_LANGUAGE_FALLBACKS: Record<number, number> = {
  91: 62, // Java 17 -> Java OpenJDK 13.0.1
  113: 71, // Python 3.14 -> Python 3.8.1
  109: 71, // Python 3.13 -> Python 3.8.1
  105: 54, // C++ 14 -> C++ GCC 9.2.0
  103: 50, // C 14 -> C GCC 9.2.0
  102: 63, // Node 22 -> Node 12.14.0
  97: 63, // Node 20 -> Node 12.14.0
};
